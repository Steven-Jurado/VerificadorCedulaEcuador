...
namespace Prueba_CI
{
    class Program
    {
        ...
        {
            if (Verificador("0993366812001"))

                Console.WriteLine("Valido");

            else

                Console.WriteLine("No Invalido");

        }

        static bool Verificador(string identificacion)
        {
            bool estado = false;
        ...
        static bool VerificaCedula(char[] validarCedula)
        {
        ...
        static bool VerificaPersonaJuridica(char[] validarCedula)
        {
            int aux = 0, prod, veri;
        ...
        static bool VerificaSectorPublico(char[] validarCedula)
        {
            int aux = 0, prod, veri;
